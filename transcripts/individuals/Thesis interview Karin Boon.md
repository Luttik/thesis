...
> *[Me]*
> *I'm also quite briefly curious in a few sentences about what you do. Then I have that framing for my research too and then we can dive into the rest.*
...
Uhm, so then I started [company] and, uhm, yeah, funny enough the competitors I, uhm, had in my, uh, market as, uhm, a distributor then asked me: okay, do you want to do the marketing for us? So, uh, that's really funny how that goes. So, uh, I represented a lot of brands in the baby market for a long time.
...
I just see real copycat behavior. I see, yeah, that's what I see. Too much AI text, too many images that really just don't stand out. Ehm, yeah, that.
...
Ehm, I see a video, I don't really see the ultimate video emerging there yet where real distinction is offered. Eh, I think that brands that do it well have found a kind of hybrid form of AI image and non-AI image. But I can't really point to, ehm, that brand is doing really well. Look, I see [company] is a nice example there. They developed a beautiful image with AI.

Based on the images they already had, so that was the panther from [company] of the brand they have, they developed the panthers and those became AI images that the brand really embraces. But in that you already see that there's an existing concept being further developed, which saves costs. So I do see a lot of things emerging there. And in the fashion industry that's generally really strong, I think.

So [company] does that, [company] does it. So they mainly look at how they can save costs on models and on a bit of creativity based on their existing concepts. And there, yeah, that's what I see.
...
> *[Me]*
> *Yeah, clear. And you? You naturally help organizations with AI adoption and use and trainings.*

[Them]
Yeah.

> *[Me]*
> *I've seen quite a lot in my research already. You're the very last person I'm going to speak to, by the way.*
...
> *[Me]*
> *No, I have. I have, but I'm also thinking for a moment. Look what I like is you, a lot of people are working with AI and then it's very much performance marketing, dashboarding, eh, personalization of course. Hey, di-digital marketing new world. While you very much, eh, also when you look at your site. You radiate something that's yeah, comparable to luxury brands, you know. Something more authentic, ehm.*

[Them]
Yeah.

> *[Me]*
> *More thought through about what. Well, you talk a lot about your unique pro-proposition. What your brand story is, how you can differentiate. And that is indeed also a bit the classic form of marketing. And classic doesn't mean old, but timeless, so to speak. And I find that funny and I'd actually like to go a bit deeper on that. But I'm looking for the right question.*

> *Because I do find it really nice that from a completely different perspective than the average marketer today you're also working on hey, what does AI mean then?*

[Them]
Well, I can, ehm. Look, why do I say this? It's that, ehm, I see that my children naturally use AI and they're fifteen and seventeen and, ehm, and I see a lot of great advantages in that. But if you don't know, ehm, what marketing is at its core, then you also, eh, you get really far with AI. But then, ehm, then I do notice that you'll miss a number of basic elements.

And then it's also the case that, ehm, when you're a brand in a market. You probably get really far with deep research and with a certain proposition, but you also really have to feel where marketing comes from. And I think that's the most important thing in education too, which is really missing right now.

So maybe the question should also be about, eh, how can education actually, eh, because you're naturally an example of that too, ehm, is that you. You also really need authentic master craftspeople in practice. Just like in the craft of, for example, I have a company, that's a woodworking company.
...
> *[Me]*
> *How does that collaboration work for you? And what does that mean for AI adoption?*

[Them]
Eh, I think a really big one. Because tech people stay tech people. With all respect, but, ehm, I think that I myself, ehm, I used to work for a web agency, for example. I built really large websites costing more than a hundred thousand for companies like [company] and that kind of thing. And look, tech people still, ehm, I think the future tech person won't even fit in a unit of tech person.

Because they'll ultimately also have to think really creatively and also have to start thinking in a different way. So I find it really interesting that the tech person of the past who had to write code to ultimately get to a website or whatever. Yeah, that person I especially see changing very positively.
